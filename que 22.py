...
# Aur ye function speed naam ka ek parameter lega. 1. Agar speed 
# 70 se kam hai to ye “ok” print karega.

    # Agar driver ki speed 70 se jyaada hai to function use har 
    # 5 km ke liye 1 point dega (ye 70 ko count nahi karega).
